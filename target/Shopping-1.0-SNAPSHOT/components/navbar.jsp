  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <ul class="navbar-nav ml-auto">
          <li class="nav-item active">
              <a class="nav-link" href="#" data-toggle="modal" data-target="#cart"> <i class="fa fa-cart-arrow-down" style="font-size:30px" aria-hidden="true"></i><span class="ml-2 cart-items" style="font-size: 20px">(0)</span></a>
          </li>
